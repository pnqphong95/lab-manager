...
@endif	
<div class="col-md-12">
   	<form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="admin/lophocphan/themexcel" class="form-horizontal" method="post" enctype="multipart/form-data">
