				...
				<tbody>
					@foreach ($allLichCD as $lichCD)
			      	<tr>						        								        	
			        	...
			        	<td>
			        		<!-- <a href="user/duyetlich/chitiet/{{Crypt::encrypt($lichCD->id)}}" class="btn btn-info btn-xs btn-xepphong">Chi tiết</a>			        		 -->
				...
				<tbody>
					@foreach ($allLCDYeuCau as $lichCD)
			      	<tr>						        								        	
			        	...
			        	<td>
			        		<a href="user/duyetlich/chitiet/{{Crypt::encrypt($lichCD->id)}}" class="btn btn-info btn-xs btn-xepphong">Chi tiết</a>			        	
		        			<a href="user/duyetlich/xepphong/{{Crypt::encrypt($lichCD->id)}}" class="btn btn-info btn-xs btn-xepphong">Xếp phòng</a>	
		        			<a href="user/duyetlich/travebm/{{Crypt::encrypt($lichCD->id)}}" class="btn btn-warning btn-xs btn-xepphong">Trả về BM</a>
	        			</td>
	     	 		</tr>
		     	 	@endforeach
		     	 </tbody>
